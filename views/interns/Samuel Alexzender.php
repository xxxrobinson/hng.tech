               ...
               <div class="col-md-12 col-sm-6 col-xs-12">
                  <div class="col-md-6 col-xs-12">
                     <div class="intern-block border-blue">
                        ...
                        <ul class="list">
                           ...
                           <li><a href="https://github.com/alexzender45" target="_blank"<i class="fab fa-github fa-2x"></i></a></li>
                           <li><a href="https://medium.com/me/publications" target="_blank"<i class="fab fa-medium fa-2x"></i></a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-md-6 col-xs-12 align-items-center">
                     <div class="intern-bio border-blue">
                        <h6>About me</h6>
                        <p>Am i web developer i build both Front-end and Back-end application,i love to build nice and good web application</p>
                        <br />
                        <h6>Skills</h6>
